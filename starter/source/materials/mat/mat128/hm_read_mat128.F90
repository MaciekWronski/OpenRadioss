...
!-----------------------------------------------
      ...
      my_real :: fisokin,fcut,asrate,xfac,yfac
...
!
      ...
      call hm_get_floatv('LAW128_ALPHA'   ,fisokin ,is_available, lsubmodel, unitab)
      ! line 7 
...
!-------------------------------------
      ...
      mat_param%uparam(18) = fisokin
      mat_param%uparam(19) = asrate
!-------------------------------------
...
!-------------------------------------------------------------------------------
      ...
      if (is_encrypted) then
        ...
        if (func_id > 0) then
          write(iout,1100) rho0,young,nu,fisokin,              &
                           func_id,ff,gg,hh,ll,mm,nn 
        else
          write(iout,1200) rho0,young,nu,sigy,fisokin,qr1,     &
                           cr1,qr2,cr2,qx1,cx1,qx2,cx2,        &
